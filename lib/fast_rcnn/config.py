...
__C.TRAIN.MASK_ON = False
__C.TRAIN.MASK_RESOLUTION = 28
__C.TRAIN.FG_FOR_MASK = 32
__C.TRAIN.IMAGE_BASE_SIZE = -1


__C.TRAIN.LABEL_SHUFFLING = False
...
__C.TEST.MASK_ON = False
__C.TEST.MASK_RESOLUTION = 28
__C.TEST.MASK_PAD = 1
__C.TEST.IMAGE_BASE_SIZE = -1
...
__C.DATASET_CATEGORY_NUMBER = 20
