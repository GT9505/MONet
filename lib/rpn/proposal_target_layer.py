...
class ProposalTargetLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        top[5].reshape(1, cfg.DATASET_CATEGORY_NUMBER, 1, 1)
    ...
    def forward(self, bottom, top):
        ...
        multiclass_labels=np.zeros(cfg.DATASET_CATEGORY_NUMBER)
        for i in range(gt_boxes.shape[0]):
            multiclass_labels[int(gt_boxes[i,-1])-1]=1
        ...
        multiclass_labels = multiclass_labels.reshape((1,cfg.DATASET_CATEGORY_NUMBER,1,1))
        top[5].reshape(*multiclass_labels.shape)
        top[5].data[...] = multiclass_labels
